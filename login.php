...
if (isset($_POST["connexion"])){
    ...
    $pdo = new PDO("mysql:host=localhost;dbname=projet_1", $user, $pass);

    $sql = $pdo->prepare("SELECT * FROM clients WHERE nom_client = ?");
...
<li>
    ...
    <input type="text" name="mdp" class="field-style field-split align-right" placeholder="Mot de passe" required/>
